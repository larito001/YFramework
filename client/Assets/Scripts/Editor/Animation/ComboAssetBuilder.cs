...
/// 一键生成一套**可玩的近战连招 demo**，落盘到 Resources/Skill/，并配合 knife 的 ComboGraphPath 跑起来：
...
public static class ComboAssetBuilder
{
    ...
    {
        "Assets/Resources/Skill/PlayerMelee.asset",
        "Assets/Resources/Skill/PlayerKnife.asset",
        "Assets/Resources/Skill/PlayerKnifeV.asset",
    };
    ...
    public static void Build()
    {
        ...
        CreateOrReplace(atk1,  "Assets/Resources/Skill/Knife_Atk1.asset");
        CreateOrReplace(atk2,  "Assets/Resources/Skill/Knife_Atk2.asset");
        CreateOrReplace(atk3,  "Assets/Resources/Skill/Knife_Atk3.asset");
        CreateOrReplace(heavy, "Assets/Resources/Skill/Knife_Heavy.asset");
        ...
        CreateOrReplace(graph, "Assets/Resources/Skill/KnifeCombo.asset");

        AssetDatabase.SaveAssets();
        AssetDatabase.Refresh();
        Debug.Log($"[ComboAssetBuilder] 完成（复用 {clips.Count} 个 clip）：Knife_Atk1/2/3 + Knife_Heavy + KnifeCombo 已生成到 Resources/Skill/。\n" +
                  "切到 knife（数字键 5）：左键连点=三连段，左左V=重击收尾，单V=重击。knife 的 ComboGraphPath 已指向 Skill/KnifeCombo。");
    }
